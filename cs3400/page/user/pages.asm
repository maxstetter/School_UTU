...
user/_pages:     file format elf64-littleriscv
...
int main(int argc, char **argv)
{
  ...
  if (argc < 2)
   e:	4785                	li	a5,1
  10:	04a7d663          	bge	a5,a0,5c <main+0x5c>
  14:	892a                	mv	s2,a0
  16:	89ae                	mv	s3,a1
  {
  ...
  1c:	83050513          	addi	a0,a0,-2000 # 848 <malloc+0x108>
  20:	00000097          	auipc	ra,0x0
  24:	668080e7          	jalr	1640(ra) # 688 <printf>
  ...
  40:	1c8080e7          	jalr	456(ra) # 204 <atoi>
  44:	00000097          	auipc	ra,0x0
  48:	35a080e7          	jalr	858(ra) # 39e <pages>
  for (i = 1; i < argc; i++)
  4c:	04a1                	addi	s1,s1,8
  4e:	ff2496e3          	bne	s1,s2,3a <main+0x3a>
  exit(0);
  52:	4501                	li	a0,0
  54:	00000097          	auipc	ra,0x0
  58:	2aa080e7          	jalr	682(ra) # 2fe <exit>
    fprintf(2, "usage: (pages, pid)\n");
  5c:	00000597          	auipc	a1,0x0
  60:	7d458593          	addi	a1,a1,2004 # 830 <malloc+0xf0>
  64:	4509                	li	a0,2
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3f6:	4ee50513          	addi	a0,a0,1262 # 8e0 <digits>
 3fa:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 4b6:	3d6c8c93          	addi	s9,s9,982 # 888 <malloc+0x148>
 ...
 4c4:	420b8b93          	addi	s7,s7,1056 # 8e0 <digits>
 ...
 5ea:	29a98993          	addi	s3,s3,666 # 880 <malloc+0x140>
        while(*s != 0){
 5ee:	85ee                	mv	a1,s11
